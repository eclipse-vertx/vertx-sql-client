...
The database version property would be used as the tag of the Postgres Docker container, if the database version is not specified, then `10.10` will be used by default for MySQL
