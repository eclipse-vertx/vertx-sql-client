      ...
      conn.query("SELECT 1 \"foo\"").execute(
        ctx.asyncAssertSuccess(result -> {
          ...
          List<Function<String, ?>> functions = Arrays.asList(
            ...
            row::getArrayOfShort,
            row::getArrayOfInteger,
            row::getArrayOfLong,
            row::getArrayOfFloat,
            row::getArrayOfDouble,
            row::getArrayOfBigDecimal,
            row::getArrayOfNumeric,
            row::getArrayOfString,
            row::getArrayOfBuffer,
            row::getArrayOfLocalDate,
            row::getArrayOfLocalTime,
            row::getArrayOfOffsetDateTime,
            row::getArrayOfLocalDateTime,
            row::getArrayOfOffsetTime,
            row::getArrayOfTemporal,
            row::getArrayOfUUID,
