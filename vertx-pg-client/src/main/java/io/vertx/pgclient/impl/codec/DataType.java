...
enum DataType {
  ...
  BOOL_ARRAY(1000, true, Boolean[].class, JDBCType.BOOLEAN, Tuple::getArrayOfBoolean),
  INT2(21, true, Short.class, Number.class, JDBCType.SMALLINT, Tuple::getShort),
  INT2_ARRAY(1005, true, Short[].class, Number[].class, JDBCType.SMALLINT, Tuple::getArrayOfShort),
  INT4(23, true, Integer.class, Number.class, JDBCType.INTEGER, Tuple::getInteger),
  INT4_ARRAY(1007, true, Integer[].class, Number[].class, JDBCType.INTEGER, Tuple::getArrayOfInteger),
  INT8(20, true, Long.class, Number.class, JDBCType.BIGINT, Tuple::getLong),
  INT8_ARRAY(1016, true, Long[].class, Number[].class, JDBCType.BIGINT, Tuple::getArrayOfLong),
  FLOAT4(700, true, Float.class, Number.class, JDBCType.REAL, Tuple::getFloat),
  FLOAT4_ARRAY(1021, true, Float[].class, Number[].class, JDBCType.REAL, Tuple::getArrayOfFloat),
  FLOAT8(701, true, Double.class, Number.class, JDBCType.DOUBLE, Tuple::getDouble),
  FLOAT8_ARRAY(1022, true, Double[].class, Number[].class, JDBCType.DOUBLE, Tuple::getArrayOfDouble),
  NUMERIC(1700, false, Numeric.class, Number.class, JDBCType.NUMERIC, Tuple::getNumeric),
  NUMERIC_ARRAY(1231, false, Numeric[].class, Number[].class, JDBCType.NUMERIC, Tuple::getArrayOfNumeric),
  ...
  CHAR_ARRAY(1002, true, String[].class, JDBCType.CHAR, Tuple::getArrayOfString),
  VARCHAR(1043, true, String.class, JDBCType.VARCHAR, Tuple::getString),
  VARCHAR_ARRAY(1015, true, String[].class, JDBCType.VARCHAR, Tuple::getArrayOfString),
  BPCHAR(1042, true, String.class, JDBCType.VARCHAR, Tuple::getString),
  BPCHAR_ARRAY(1014, true, String[].class, JDBCType.VARCHAR, Tuple::getArrayOfString),
  TEXT(25, true, String.class, JDBCType.LONGVARCHAR, Tuple::getString),
  TEXT_ARRAY(1009, true, String[].class, JDBCType.LONGVARCHAR, Tuple::getArrayOfString),
  NAME(19, true, String.class, JDBCType.VARCHAR, Tuple::getString),
  NAME_ARRAY(1003, true, String[].class, JDBCType.VARCHAR, Tuple::getArrayOfString),
  DATE(1082, true, LocalDate.class, JDBCType.DATE, Tuple::getLocalDate),
  DATE_ARRAY(1182, true, LocalDate[].class, JDBCType.DATE, Tuple::getArrayOfLocalDate),
  TIME(1083, true, LocalTime.class, JDBCType.TIME, Tuple::getLocalTime),
  TIME_ARRAY(1183, true, LocalTime[].class, JDBCType.TIME, Tuple::getArrayOfLocalTime),
  TIMETZ(1266, true, OffsetTime.class, JDBCType.TIME_WITH_TIMEZONE, Tuple::getOffsetTime),
  TIMETZ_ARRAY(1270, true, OffsetTime[].class, JDBCType.TIME_WITH_TIMEZONE, Tuple::getArrayOfOffsetTime),
  TIMESTAMP(1114, true, LocalDateTime.class, JDBCType.TIMESTAMP, Tuple::getLocalDateTime),
  TIMESTAMP_ARRAY(1115, true, LocalDateTime[].class, JDBCType.TIMESTAMP, Tuple::getArrayOfLocalDateTime),
  TIMESTAMPTZ(1184, true, OffsetDateTime.class, JDBCType.TIMESTAMP_WITH_TIMEZONE, Tuple::getOffsetDateTime),
  TIMESTAMPTZ_ARRAY(1185, true, OffsetDateTime[].class, JDBCType.TIMESTAMP_WITH_TIMEZONE, Tuple::getArrayOfOffsetDateTime),
  ...
  BYTEA_ARRAY(1001, true, Buffer[].class, JDBCType.BINARY, Tuple::getArrayOfBuffer),
  ...
  UUID_ARRAY(2951, true, UUID[].class, JDBCType.OTHER, Tuple::getArrayOfUUID),
  JSON(114, true, Object.class, JDBCType.OTHER, Tuple::getJsonElement),
  JSON_ARRAY(199, true, Object[].class, JDBCType.OTHER, Tuple::getArrayOfJsonElement),
  JSONB(3802, true, Object.class, JDBCType.OTHER, Tuple::getJsonElement),
  JSONB_ARRAY(3807, true, Object[].class, JDBCType.OTHER, Tuple::getArrayOfJsonElement),
