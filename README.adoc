...
- [vertx-jooq](https://github.com/jklingsporn/vertx-jooq): writing type safe queries and let them run at high speed using jOOQ, vertx and the reactive-pg-client.
