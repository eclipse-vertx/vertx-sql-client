...
** `mvn compile` to generate link:jekyll/guide/java/index.md[jekyll/guide/java/index.md]
** `mvn site` to generate the javadoc in link:jekyll/apidocs[jekyll/apidocs]
* run Jekyll
** `cd jekyll`
** `docker-compose up`
