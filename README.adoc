...
[![Build Status](https://github.com/eclipse-vertx/vertx-sql-client/workflows/CI/badge.svg?branch=3.0)](https://github.com/eclipse-vertx/vertx-sql-client/actions?query=workflow%3ACI)
