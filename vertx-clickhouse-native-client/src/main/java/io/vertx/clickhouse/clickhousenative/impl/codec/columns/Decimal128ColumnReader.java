...
public class Decimal128ColumnReader extends ClickhouseColumnReader {
  ...
  protected Decimal128ColumnReader(int nRows, ClickhouseNativeColumnDescriptor columnDescriptor) {
