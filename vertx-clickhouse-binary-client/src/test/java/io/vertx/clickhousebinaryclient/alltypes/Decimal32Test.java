...
import io.vertx.clickhouse.clickhouse.binary.impl.codec.columns.Decimal32Column;
...
public class Decimal32Test extends AllTypesBase<Numeric> {
  public static final int SCALE = 4;

  public static final MathContext MATH_CONTEXT = new MathContext(Decimal32Column.MAX_PRECISION, RoundingMode.HALF_EVEN);

  public Decimal32Test() {
    super("decimal32", new MyColumnChecker<>(Numeric.class, Tuple::getNumeric, Row::getNumeric, Tuple::getArrayOfNumerics, Row::getArrayOfNumerics), false);
  }

  private Numeric nm(Integer src) {
    BigInteger bi = BigInteger.valueOf(src);
    BigDecimal bd = new BigDecimal(bi, SCALE, MATH_CONTEXT);
    return Numeric.create(bd);
  }

  @Override
  public List<Tuple> createBatch() {
    int mni = Integer.MAX_VALUE / 3;
    int mxi = Integer.MIN_VALUE / 3;
