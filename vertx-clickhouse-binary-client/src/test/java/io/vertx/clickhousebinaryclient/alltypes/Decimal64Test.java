...
import io.vertx.clickhouse.clickhouse.binary.impl.codec.columns.Decimal64Column;
...
public class Decimal64Test extends AllTypesBase<Numeric> {
  public static final int SCALE = 4;

  public static final MathContext MATH_CONTEXT = new MathContext(Decimal64Column.MAX_PRECISION, RoundingMode.HALF_EVEN);

  public Decimal64Test() {
    super("decimal64", new MyColumnChecker<>(Numeric.class, Tuple::getNumeric, Row::getNumeric, Tuple::getArrayOfNumerics, Row::getArrayOfNumerics), false);
  }
  ...
  public List<Tuple> createBatch() {
    long mnl = Long.MIN_VALUE / 10;
    long mxl = Long.MAX_VALUE / 10;
