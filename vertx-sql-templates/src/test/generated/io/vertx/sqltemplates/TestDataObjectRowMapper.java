...
public class TestDataObjectRowMapper implements java.util.function.Function<io.vertx.sqlclient.Row, TestDataObject> {
  ...
  public TestDataObject apply(io.vertx.sqlclient.Row row) {
    ...
    if (val != null) {
      obj.setBooleanMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toBoolean((java.lang.Boolean)val));
    }
    val = row.getBooleanArray("booleanMethodMappedDataObjectList");
    if (val != null) {
      obj.setBooleanMethodMappedDataObjectList(java.util.Arrays.stream((java.lang.Boolean[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toBoolean(elt)).collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new)));
    }
    val = row.getBooleanArray("booleanMethodMappedDataObjectSet");
    if (val != null) {
      obj.setBooleanMethodMappedDataObjectSet(java.util.Arrays.stream((java.lang.Boolean[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toBoolean(elt)).collect(java.util.stream.Collectors.toCollection(java.util.HashSet::new)));
    }
    ...
    if (val != null) {
      obj.setDoubleMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toDouble((java.lang.Double)val));
    }
    val = row.getDoubleArray("doubleMethodMappedDataObjectList");
    if (val != null) {
      obj.setDoubleMethodMappedDataObjectList(java.util.Arrays.stream((java.lang.Double[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toDouble(elt)).collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new)));
    }
    val = row.getDoubleArray("doubleMethodMappedDataObjectSet");
    if (val != null) {
      obj.setDoubleMethodMappedDataObjectSet(java.util.Arrays.stream((java.lang.Double[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toDouble(elt)).collect(java.util.stream.Collectors.toCollection(java.util.HashSet::new)));
    }
    ...
    if (val != null) {
      obj.setFloatMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toFloat((java.lang.Float)val));
    }
    val = row.getFloatArray("floatMethodMappedDataObjectList");
    if (val != null) {
      obj.setFloatMethodMappedDataObjectList(java.util.Arrays.stream((java.lang.Float[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toFloat(elt)).collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new)));
    }
    val = row.getFloatArray("floatMethodMappedDataObjectSet");
    if (val != null) {
      obj.setFloatMethodMappedDataObjectSet(java.util.Arrays.stream((java.lang.Float[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toFloat(elt)).collect(java.util.stream.Collectors.toCollection(java.util.HashSet::new)));
    }
    ...
    if (val != null) {
      obj.setIntegerMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toInteger((java.lang.Integer)val));
    }
    val = row.getIntegerArray("integerMethodMappedDataObjectList");
    if (val != null) {
      obj.setIntegerMethodMappedDataObjectList(java.util.Arrays.stream((java.lang.Integer[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toInteger(elt)).collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new)));
    }
    val = row.getIntegerArray("integerMethodMappedDataObjectSet");
    if (val != null) {
      obj.setIntegerMethodMappedDataObjectSet(java.util.Arrays.stream((java.lang.Integer[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toInteger(elt)).collect(java.util.stream.Collectors.toCollection(java.util.HashSet::new)));
    }
    ...
    if (val != null) {
      obj.setJsonArrayMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toJsonArray((io.vertx.core.json.JsonArray)val));
    }
    val = row.getJsonArrayArray("jsonArrayMethodMappedDataObjectList");
    if (val != null) {
      obj.setJsonArrayMethodMappedDataObjectList(java.util.Arrays.stream((io.vertx.core.json.JsonArray[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toJsonArray(elt)).collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new)));
    }
    val = row.getJsonArrayArray("jsonArrayMethodMappedDataObjectSet");
    if (val != null) {
      obj.setJsonArrayMethodMappedDataObjectSet(java.util.Arrays.stream((io.vertx.core.json.JsonArray[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toJsonArray(elt)).collect(java.util.stream.Collectors.toCollection(java.util.HashSet::new)));
    }
    ...
    if (val != null) {
      obj.setJsonObjectDataObject(new io.vertx.sqltemplates.JsonObjectDataObject((io.vertx.core.json.JsonObject)val));
    }
    val = row.getJsonObjectArray("jsonObjectDataObjectList");
    if (val != null) {
      obj.setJsonObjectDataObjectList(java.util.Arrays.stream((io.vertx.core.json.JsonObject[])val).map(elt -> new io.vertx.sqltemplates.JsonObjectDataObject(elt)).collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new)));
    }
    val = row.getJsonObjectArray("jsonObjectDataObjectSet");
    if (val != null) {
      obj.setJsonObjectDataObjectSet(java.util.Arrays.stream((io.vertx.core.json.JsonObject[])val).map(elt -> new io.vertx.sqltemplates.JsonObjectDataObject(elt)).collect(java.util.stream.Collectors.toCollection(java.util.HashSet::new)));
    }
    ...
    if (val != null) {
      obj.setJsonObjectMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toJsonObject((io.vertx.core.json.JsonObject)val));
    }
    val = row.getJsonObjectArray("jsonObjectMethodMappedDataObjectList");
    if (val != null) {
      obj.setJsonObjectMethodMappedDataObjectList(java.util.Arrays.stream((io.vertx.core.json.JsonObject[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toJsonObject(elt)).collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new)));
    }
    val = row.getJsonObjectArray("jsonObjectMethodMappedDataObjectSet");
    if (val != null) {
      obj.setJsonObjectMethodMappedDataObjectSet(java.util.Arrays.stream((io.vertx.core.json.JsonObject[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toJsonObject(elt)).collect(java.util.stream.Collectors.toCollection(java.util.HashSet::new)));
    }
    ...
    if (val != null) {
      obj.setLongMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toLong((java.lang.Long)val));
    }
    val = row.getLongArray("longMethodMappedDataObjectList");
    if (val != null) {
      obj.setLongMethodMappedDataObjectList(java.util.Arrays.stream((java.lang.Long[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toLong(elt)).collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new)));
    }
    val = row.getLongArray("longMethodMappedDataObjectSet");
    if (val != null) {
      obj.setLongMethodMappedDataObjectSet(java.util.Arrays.stream((java.lang.Long[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toLong(elt)).collect(java.util.stream.Collectors.toCollection(java.util.HashSet::new)));
    }
    ...
    if (val != null) {
      obj.setShortMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toShort((java.lang.Short)val));
    }
    val = row.getShortArray("shortMethodMappedDataObjectList");
    if (val != null) {
      obj.setShortMethodMappedDataObjectList(java.util.Arrays.stream((java.lang.Short[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toShort(elt)).collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new)));
    }
    val = row.getShortArray("shortMethodMappedDataObjectSet");
    if (val != null) {
      obj.setShortMethodMappedDataObjectSet(java.util.Arrays.stream((java.lang.Short[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toShort(elt)).collect(java.util.stream.Collectors.toCollection(java.util.HashSet::new)));
    }
    ...
    if (val != null) {
      obj.setStringMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toString((java.lang.String)val));
    }
    val = row.getStringArray("stringMethodMappedDataObjectList");
    if (val != null) {
      obj.setStringMethodMappedDataObjectList(java.util.Arrays.stream((java.lang.String[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toString(elt)).collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new)));
    }
    val = row.getStringArray("stringMethodMappedDataObjectSet");
    if (val != null) {
      obj.setStringMethodMappedDataObjectSet(java.util.Arrays.stream((java.lang.String[])val).map(elt -> io.vertx.sqltemplates.DataObjectMapper.toString(elt)).collect(java.util.stream.Collectors.toCollection(java.util.HashSet::new)));
    }
    ...
    if (val != null) {
      for (java.lang.Boolean elt : (java.lang.Boolean[])val) {
        obj.addAddedBooleanMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toBoolean(elt));
      }
    }
    ...
    if (val != null) {
      for (java.lang.Double elt : (java.lang.Double[])val) {
        obj.addAddedDoubleMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toDouble(elt));
      }
    }
    ...
    if (val != null) {
      for (java.lang.Float elt : (java.lang.Float[])val) {
        obj.addAddedFloatMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toFloat(elt));
      }
    }
    ...
    if (val != null) {
      for (java.lang.Integer elt : (java.lang.Integer[])val) {
        obj.addAddedIntegerMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toInteger(elt));
      }
    }
    ...
    if (val != null) {
      for (io.vertx.core.json.JsonArray elt : (io.vertx.core.json.JsonArray[])val) {
        obj.addAddedJsonArrayMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toJsonArray(elt));
      }
    }
    ...
    if (val != null) {
      for (io.vertx.core.json.JsonObject elt : (io.vertx.core.json.JsonObject[])val) {
        obj.addAddedJsonObjectDataObject(new io.vertx.sqltemplates.JsonObjectDataObject(elt));
      }
    }
    val = row.getJsonObjectArray("addedJsonObjectMethodMappedDataObjects");
    if (val != null) {
      for (io.vertx.core.json.JsonObject elt : (io.vertx.core.json.JsonObject[])val) {
        obj.addAddedJsonObjectMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toJsonObject(elt));
      }
    }
    ...
    if (val != null) {
      for (java.lang.Long elt : (java.lang.Long[])val) {
        obj.addAddedLongMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toLong(elt));
      }
    }
    ...
    if (val != null) {
      for (java.lang.Short elt : (java.lang.Short[])val) {
        obj.addAddedShortMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toShort(elt));
      }
    }
    ...
    if (val != null) {
      for (java.lang.String elt : (java.lang.String[])val) {
        obj.addAddedStringMethodMappedDataObject(io.vertx.sqltemplates.DataObjectMapper.toString(elt));
      }
    }
