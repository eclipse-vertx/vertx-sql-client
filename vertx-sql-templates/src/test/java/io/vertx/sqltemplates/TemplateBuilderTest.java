...
import io.vertx.sqltemplates.impl.SqlTemplate;
...
public class TemplateBuilderTest {
  ...
  private void assertPgTuple(String template, Map<String, Object> params, Tuple expectedTuple) {
    io.vertx.sqltemplates.impl.SqlTemplate blah = pgTemplate(template);
    Tuple tuple = blah.mapTuple(params);
    assertTupleEquals(tuple, expectedTuple);
  }

  private io.vertx.sqltemplates.impl.SqlTemplate pgTemplate(String template) {
    return io.vertx.sqltemplates.impl.SqlTemplate.create(new FakeClient() {
      @Override
  ...
  private void assertOtherTuple(String template, Map<String, Object> params, Tuple expectedTuple) {
    io.vertx.sqltemplates.impl.SqlTemplate blah = otherTemplate(template);
    Tuple tuple = blah.mapTuple(params);
    assertTupleEquals(tuple, expectedTuple);
  }

  private io.vertx.sqltemplates.impl.SqlTemplate otherTemplate(String template) {
