...
|===
^|Name | Type ^| Description
|[[accessMode]]`@accessMode`|`link:enums.html#TransactionAccessMode[TransactionAccessMode]`|+++
Set the link in the options.
+++
|[[isolationLevel]]`@isolationLevel`|`link:enums.html#TransactionIsolationLevel[TransactionIsolationLevel]`|+++
Set the link in the options.
+++
|===
