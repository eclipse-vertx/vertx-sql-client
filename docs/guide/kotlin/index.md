...
// Create a tuple
var tuple = Tuple.of(Json.create(null), Json.create(json {
  obj("foo" to "bar")
}), Json.create(3))

//
tuple = Tuple.tuple().addJson(Json.create(null)).addJson(Json.create(json {
  obj("foo" to "bar")
})).addJson(Json.create(3))

// JSON object (and arrays) can also be added directly
tuple = Tuple.tuple().addJson(Json.create(null)).addJsonObject(json {
  obj("foo" to "bar")
}).addJson(Json.create(3))
