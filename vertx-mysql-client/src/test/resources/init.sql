...
(
    ...
    `test_varchar_binary`                VARCHAR(50) BINARY,
    `test_varchar_with_binary_collation` VARCHAR(50) COLLATE `binary`,
    `test_text_binary`                   TEXT BINARY
);
...
VALUES (1, 'HELLO', 'HELLO, WORLD', 'TINYBLOB', 'BLOB', 'MEDIUMBLOB', 'LONGBLOB', 'TINYTEXT', 'TEXT', 'MEDIUMTEXT',
        ...
        16777215, 4294967295, 18446744073709551615, 'VARCHAR binary', 'VARCHAR with binary collation', 'TEXT binary');
INSERT INTO datatype
