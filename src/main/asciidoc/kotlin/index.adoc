...
The `link:../../apidocs/com/julienviet/pgclient/Json.html[Json]` Java type is used to represent the Postgres `JSON` and `JSONB` type.
...
The `link:../../apidocs/com/julienviet/pgclient/Numeric.html[Numeric]` Java type is used to represent the Postgres `NUMERIC` type.
