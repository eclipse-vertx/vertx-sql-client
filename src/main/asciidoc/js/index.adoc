...
`link:../../jsdoc/module-reactive-pg-client-js_pg_connection-PgConnection.html[connection]`.
...
Query methods provides an asynchronous `link:../../jsdoc/module-reactive-pg-client-js_pg_result-PgResult.html[PgResult]` instance that works for _SELECT_ queries
...
The `link:../../jsdoc/module-reactive-pg-client-js_row-Row.html[Row]` gives you access to your data by index
...
does not depend on whether you are creating prepared queries or use `link:../../jsdoc/module-reactive-pg-client-js_pg_client-PgClient.html#preparedQuery[direct prepared queries]`

By default prepared query executions fetch all results, you can use a `link:../../jsdoc/module-reactive-pg-client-js_pg_cursor-PgCursor.html[PgCursor]` to control the amount of rows you want to read:
...
`link:../../jsdoc/module-reactive-pg-client-js_pg_prepared_query-PgPreparedQuery.html[PgPreparedQuery]` can perform efficient batching:
...
a `link:../../jsdoc/module-reactive-pg-client-js_pg_connection-PgConnection.html[PgConnection]` and manage it yourself.

Or you can use the transaction API of `link:../../jsdoc/module-reactive-pg-client-js_pg_connection-PgConnection.html[PgConnection]`:
...
end of transaction block_), the transaction is rollbacked and the `link:../../jsdoc/module-reactive-pg-client-js_pg_transaction-PgTransaction.html#abortHandler[abortHandler]`
is called:
...
The `link:../../jsdoc/module-reactive-pg-client-js_json-Json.html[Json]` Java type is used to represent the Postgres `JSON` and `JSONB` type.
...
You can set a `link:../../jsdoc/module-reactive-pg-client-js_pg_connection-PgConnection.html#notificationHandler[notificationHandler]` to receive
...
The `link:../../jsdoc/module-reactive-pg-client-js_pg_subscriber-PgSubscriber.html[PgSubscriber]` is a channel manager managing a single connection that
