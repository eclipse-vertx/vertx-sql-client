    ...
    query.execute(function (ar2, ar2_err) {
      ...
      if (ar2_err == null) {
        ...
        if (query.hasNext()) {
          ...
          query.next(function (ar3, ar3_err) {
            // ...
          });
        } else {
          // We are done
...
----
var Tuple = require("vertx-pg-client-js/tuple");
conn.prepare("UPDATE USERS SET name=$1 WHERE id=$2", function (ar1, ar1_err) {

  if (ar1_err == null) {
    var preparedStatement = ar1;

    // Create an update : bind parameters
    var update = preparedStatement.query(Tuple.of(2, "EMAD ALBLUESHI"));
    ...
    // Or fluently
    preparedStatement.query(Tuple.of(1, "JULIEN VIET")).execute(function (res, res_err) {
      if (res_err == null) {
        // Process results
        var result = res;
      } else {
