...
`link:../../yardoc/ReactivePgClient/PgConnection.html[connection]`.
...
Query methods provides an asynchronous `link:../../yardoc/ReactivePgClient/PgResult.html[PgResult]` instance that works for _SELECT_ queries
...
The `link:../../yardoc/ReactivePgClient/Row.html[Row]` gives you access to your data by index
...
does not depend on whether you are creating prepared queries or use `link:../../yardoc/ReactivePgClient/PgClient.html#prepared_query-instance_method[direct prepared queries]`

By default prepared query executions fetch all results, you can use a `link:../../yardoc/ReactivePgClient/PgCursor.html[PgCursor]` to control the amount of rows you want to read:
...
`link:../../yardoc/ReactivePgClient/PgPreparedQuery.html[PgPreparedQuery]` can perform efficient batching:
...
a `link:../../yardoc/ReactivePgClient/PgConnection.html[PgConnection]` and manage it yourself.

Or you can use the transaction API of `link:../../yardoc/ReactivePgClient/PgConnection.html[PgConnection]`:
...
end of transaction block_), the transaction is rollbacked and the `link:../../yardoc/ReactivePgClient/PgTransaction.html#abort_handler-instance_method[abortHandler]`
is called:
...
The `link:../../yardoc/ReactivePgClient/Json.html[Json]` Java type is used to represent the Postgres `JSON` and `JSONB` type.
...
You can set a `link:../../yardoc/ReactivePgClient/PgConnection.html#notification_handler-instance_method[notificationHandler]` to receive
...
The `link:../../yardoc/ReactivePgClient/PgSubscriber.html[PgSubscriber]` is a channel manager managing a single connection that
