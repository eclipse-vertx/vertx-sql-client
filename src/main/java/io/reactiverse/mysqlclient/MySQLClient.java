...
public interface MySQLClient {
  ...
  MySQLClient preparedQuery(String sql, Handler<AsyncResult<PgRowSet>> handler);

  <R> MySQLClient preparedQuery(String sql, Collector<Row, ?, R> collector, Handler<AsyncResult<PgResult<R>>> handler);

  MySQLClient preparedQuery(String sql, Tuple arguments, Handler<AsyncResult<PgRowSet>> handler);

  <R> MySQLClient preparedQuery(String sql, Tuple arguments, Collector<Row, ?, R> collector, Handler<AsyncResult<PgResult<R>>> handler);
}
