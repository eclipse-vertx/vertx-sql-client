...
import io.reactiverse.myclient.impl.CharacterSetMapping;
...
import static io.reactiverse.myclient.impl.protocol.CapabilitiesFlag.CLIENT_CONNECT_ATTRS;
import static io.reactiverse.myclient.impl.protocol.CapabilitiesFlag.CLIENT_CONNECT_WITH_DB;
import static io.reactiverse.myclient.impl.protocol.CapabilitiesFlag.CLIENT_PLUGIN_AUTH;
import static io.reactiverse.myclient.impl.protocol.CapabilitiesFlag.CLIENT_PLUGIN_AUTH_LENENC_CLIENT_DATA;
import static io.reactiverse.myclient.impl.protocol.CapabilitiesFlag.CLIENT_SECURE_CONNECTION;
...
public class MyEncoder extends MessageToByteEncoder<CommandBase<?>> {
  ...
  MyEncoder(ArrayDeque<CommandCodec<?, ?>> inflight) {
