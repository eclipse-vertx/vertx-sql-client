...
class PreparedUpdateWithParamsCommand extends UpdateCommandBase {
  ...
  PreparedUpdateWithParamsCommand(String sql, List<Object> params, Handler<AsyncResult<UpdateResult>> handler) {
    this(true, sql, "", params, handler);
  }

  PreparedUpdateWithParamsCommand(boolean parse, String sql, String stmt, List<Object> params, Handler<AsyncResult<UpdateResult>> handler) {
    this.parse = parse;
    this.sql = sql;
    this.stmt = stmt;
    this.params = params;
