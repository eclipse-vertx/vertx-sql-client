...
public interface PgPreparedStatement {
   ...
   * @return create a query from this statement with one argument
   */
  default PgUpdate update(Object param1) {
    return update(Collections.singletonList(param1));
  }
   ...
   * @return create a query from this statement with two arguments
   */
  default PgUpdate update(Object param1, Object param2) {
    return update(Arrays.asList(param1, param2));
  }
   ...
   * @return create a query from this statement with three arguments
   */
  default PgUpdate update(Object param1, Object param2, Object param3) {
    return update(Arrays.asList(param1, param2, param3));
  }
   ...
   * @return create a query from this statement with four arguments
   */
  default PgUpdate update(Object param1, Object param2, Object param3, Object param4) {
    return update(Arrays.asList(param1, param2, param3, param4));
  }
   ...
   * @return create a query from this statement with five arguments
   */
  default PgUpdate update(Object param1, Object param2, Object param3, Object param4, Object param5) {
    return update(Arrays.asList(param1, param2, param3, param4, param5));
  }
   ...
   * @return create a query from this statement with six arguments
   */
  default PgUpdate update(Object param1, Object param2, Object param3, Object param4, Object param5, Object param6) {
    return update(Arrays.asList(param1, param2, param3, param4, param5, param6));
  }

  /**
   * @param params the list of arguments
   * @return create a update query from this statement with a variable list of arguments
   */
  @GenIgnore
  PgUpdate update(List<Object> params);
