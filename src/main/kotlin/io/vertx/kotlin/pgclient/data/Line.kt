 ...
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [io.vertx.pgclient.data.Line original] using Vert.x codegen.
 */
fun Line(
  a: Double? = null,
  b: Double? = null,
  c: Double? = null): Line = io.vertx.pgclient.data.Line().apply {
