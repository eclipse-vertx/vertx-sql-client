...
/**
 * Converter for {@link com.julienviet.pgclient.PgNotification}.
 *
 * NOTE: This class has been automatically generated from the {@link com.julienviet.pgclient.PgNotification} original class using Vert.x codegen.
 */
public class PgNotificationConverter {

  public static void fromJson(JsonObject json, PgNotification obj) {
    ...
    if (json.getValue("processId") instanceof Number) {
      obj.setProcessId(((Number)json.getValue("processId")).intValue());
    }
  }
