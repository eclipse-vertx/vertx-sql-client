    ...
    PgConnection.connect(vertx, options, ctx.asyncAssertSuccess(conn -> {
      conn
        ...
        .execute(ctx.asyncAssertSuccess(result ->{
          ...
          ctx.assertEquals("VERT.X VERT.X VERT.X VERT.X VERT.X VERT.X VERT.X VERT.X VERT.X ", value);
          // must be 63 length
    ...
    PgConnection.connect(vertx, options, ctx.asyncAssertSuccess(conn -> {
      conn
        ...
        .execute(ctx.asyncAssertSuccess(result ->{
          ...
          ctx.assertEquals("pgClient       ", value);
    ...
    PgConnection.connect(vertx, options, ctx.asyncAssertSuccess(conn -> {
      conn
        ...
        .execute(ctx.asyncAssertSuccess(result ->{
          ...
          ctx.assertEquals("50867d3d-0098-4f61-bd31-9309ebf53475", result.iterator().next().getValue(0));
          ctx.assertNull(result.iterator().next().getBoolean(0));
          ctx.assertNull(result.iterator().next().getLong(0));
          ctx.assertNull(result.iterator().next().getInteger(0));
          ctx.assertNull(result.iterator().next().getFloat(0));
    ...
    PgConnection.connect(vertx, options, ctx.asyncAssertSuccess(conn -> {
      conn
        ...
        .execute(ctx.asyncAssertSuccess(result ->{
          ...
          ctx.assertEquals(LocalDate.parse("1981-05-30"), result.iterator().next().getValue(0));
          ctx.assertNull(result.iterator().next().getBoolean(0));
          ctx.assertNull(result.iterator().next().getLong(0));
          ctx.assertNull(result.iterator().next().getInteger(0));
          ctx.assertNull(result.iterator().next().getFloat(0));
    ...
    PgConnection.connect(vertx, options, ctx.asyncAssertSuccess(conn -> {
      conn
        ...
        .execute(ctx.asyncAssertSuccess(result ->{
          ...
          ctx.assertEquals(LocalTime.parse("17:55:04.905120"), result.iterator().next().getValue(0));
          ctx.assertNull(result.iterator().next().getBoolean(0));
          ctx.assertNull(result.iterator().next().getLong(0));
          ctx.assertNull(result.iterator().next().getInteger(0));
          ctx.assertNull(result.iterator().next().getFloat(0));
    ...
    PgConnection.connect(vertx, options, ctx.asyncAssertSuccess(conn -> {
      conn
        ...
        .execute(ctx.asyncAssertSuccess(result ->{
          ...
          ctx.assertEquals(OffsetTime.parse("17:55:04.905120+03:07"), result.iterator().next().getValue(0));
          ctx.assertNull(result.iterator().next().getBoolean(0));
          ctx.assertNull(result.iterator().next().getLong(0));
          ctx.assertNull(result.iterator().next().getInteger(0));
          ctx.assertNull(result.iterator().next().getFloat(0));
  ...
  public void testTimestamp(TestContext ctx) {
    ...
    PgConnection.connect(vertx, options, ctx.asyncAssertSuccess(conn -> {
      conn
        ...
        .execute(ctx.asyncAssertSuccess(result ->{
          ctx.assertEquals(1, result.size());
          ctx.assertEquals(LocalDateTime.parse("2017-05-14T19:35:58.237666"),
            result.iterator().next().getLocalDateTime(0));
          ctx.assertEquals(LocalDateTime.parse("2017-05-14T19:35:58.237666"),
            result.iterator().next().getTemporal(0));
          ctx.assertEquals(LocalDateTime.parse("2017-05-14T19:35:58.237666"),
            result.iterator().next().getValue(0));
          ctx.assertNull(result.iterator().next().getBoolean(0));
          ctx.assertNull(result.iterator().next().getLong(0));
          ctx.assertNull(result.iterator().next().getInteger(0));
          ctx.assertNull(result.iterator().next().getFloat(0));
      ...
      conn.createQuery("SET TIME ZONE 'UTC'").execute(ctx.asyncAssertSuccess(v -> {
        conn.createQuery("SELECT '2017-05-14 22:35:58.237666-03'::TIMESTAMPTZ").execute(
          ctx.asyncAssertSuccess(result -> {
            ctx.assertEquals(1, result.size());
            ctx.assertEquals(OffsetDateTime.parse("2017-05-15T01:35:58.237666Z"),
              result.iterator().next().getOffsetDateTime(0));
            ctx.assertEquals(OffsetDateTime.parse("2017-05-15T01:35:58.237666Z"),
              result.iterator().next().getTemporal(0));
            ctx.assertEquals(OffsetDateTime.parse("2017-05-15T01:35:58.237666Z"),
              result.iterator().next().getValue(0));
    ...
    PgConnection.connect(vertx, options, ctx.asyncAssertSuccess(conn -> {
      conn.createQuery("SELECT ' true '::JSONB, ' false '::JSONB, ' null '::JSONB, ' 7.502 '::JSONB, ' 8 '::JSONB, '\" Really Awesome! \"'::JSONB")
        .execute(ctx.asyncAssertSuccess(result -> {
          ...
          ctx.assertNull(result.iterator().next().getBinary(1));
          ...
          ctx.assertNull(result.iterator().next().getBinary(2));
          ...
          ctx.assertNull(result.iterator().next().getBinary(3));
          ...
          ctx.assertNull(result.iterator().next().getBinary(4));
          ...
          ctx.assertNull(result.iterator().next().getBinary(5));
  ...
  public void testBytea(TestContext ctx) {
    ...
    PgConnection.connect(vertx, options, ctx.asyncAssertSuccess(conn -> {
      conn.createQuery("SELECT '12345678910'::BYTEA, '\u00DE\u00AD\u00BE\u00EF'::BYTEA").execute(
        ctx.asyncAssertSuccess(result -> {
          ctx.assertEquals(1, result.size());
          ctx.assertEquals("12345678910", result.iterator().next().getBinary(0).toString(UTF_8));
          ...
          ctx.assertEquals("\u00DE\u00AD\u00BE\u00EF", result.iterator().next().getBinary(1).toString(UTF_8));
