...
public class TestCopyTuple {
  ...
  public void testJsonTypes() {
    ...
    tuple.addJsonb(json);
    tuple.addJson(json);
    Assert.assertEquals(DataType.JSONB, tuple.getDateType(0));
    Assert.assertEquals(json, tuple.getJsonb(0));
    Assert.assertEquals(DataType.JSON, tuple.getDateType(1));
  ...
  public void testNumericTypes() {
    ...
    Assert.assertEquals(DataType.INT4, tuple.getDateType(0));
    Assert.assertEquals(new Integer(100), tuple.getInteger(0));
    Assert.assertEquals(DataType.INT2, tuple.getDateType(1));
    Assert.assertEquals(new Short((short)100), tuple.getShort(1));
    Assert.assertEquals(DataType.FLOAT8, tuple.getDateType(2));
    Assert.assertEquals(new Double(10.5), tuple.getDouble(2));
    Assert.assertEquals(DataType.FLOAT4, tuple.getDateType(3));
    Assert.assertEquals(new Float((float)10.5), tuple.getFloat(3));
    Assert.assertEquals(DataType.INT8, tuple.getDateType(4));
    Assert.assertEquals(new Long(100), tuple.getLong(4));
    Assert.assertEquals(DataType.NUMERIC, tuple.getDateType(5));
  ...
  public void testTextTypes() {
    ...
    Assert.assertEquals(DataType.TEXT, tuple.getDateType(0));
    Assert.assertEquals("hello", tuple.getString(0));
    Assert.assertEquals(DataType.VARCHAR, tuple.getDateType(1));
  ...
  public void testDateTypes() {
    ...
    Assert.assertEquals(DataType.DATE, tuple.getDateType(0));
    Assert.assertEquals(localDate, tuple.getLocalDate(0));
    Assert.assertEquals(DataType.TIME, tuple.getDateType(1));
    Assert.assertEquals(localTime, tuple.getLocalTime(1));
    Assert.assertEquals(DataType.TIMETZ, tuple.getDateType(2));
    Assert.assertEquals(offsetTime, tuple.getOffsetTime(2));
    Assert.assertEquals(DataType.TIMESTAMP, tuple.getDateType(3));
    Assert.assertEquals(localDateTime, tuple.getLocalDateTime(3));
    Assert.assertEquals(DataType.TIMESTAMPTZ, tuple.getDateType(4));
  ...
  public void testUuidType() {
    ...
    tuple.addUUID(uuid);
    Assert.assertEquals(DataType.UUID, tuple.getDateType(0));
  ...
  public void testBooleanType() {
    ...
    Assert.assertEquals(DataType.BOOL, tuple.getDateType(0));
